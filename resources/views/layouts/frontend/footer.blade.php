    ...
    <div class="container">
        <div class="row justify-content-center pt-6 sm-pt-40px">
            ...
            <div
                ...
                <a href="https://cybersparkglobal.com/" class="footer-logo mb-15px d-inline-block"><img
                        src="{{ asset('images/slider/cyber spark global official logo 10 .webp') }}"
                        data-at2x="{{ asset('images/slider/cyber spark global official logo 10 .webp') }}"
                        alt="Cyber Spark Official footer logo "></a>
                ...
                <div class="elements-social social-icon-style-02 mt-20px xs-mt-15px">
                    <ul class="medium-icon dark">
                        <li class="my-0"><a class="facebook" href="https://www.facebook.com/Cybersparkglobal/"
                                            target="_blank"><i class="fa-brands fa-facebook-f"></i></a></li>
                        <li class="my-0"><a class="linkedin" href="https://www.linkedin.com/in/helal-ahmed-53b562183/"
                                            target="_blank"><i class="fa-brands fa-linkedin"></i></a></li>
                        <li class="my-0"><a class="twitter" href="https://x.com/CybersparkG" target="_blank"><i
                                    class="fa-brands fa-twitter"></i></a></li>
                        <li class="my-0"><a class="youtube"
                                            href="https://www.youtube.com/channel/UCu5yUMUYLNpqsQOPvzsYJPw"
            ...
            <div class="col-6 col-xl-2 col-lg-3 col-sm-4 xs-mb-30px order-sm-4 order-lg-3">
                ...
                <ul>
                    <li><a href="https://cybersparkglobal.com/services">Website</a></li>
                    <li><a href="https://cybersparkglobal.com/services">Software</a></li>
                    <li><a href="https://cybersparkglobal.com/services">UI/UX Design</a></li>
                    <li><a href="https://cybersparkglobal.com/services">SEO and Marketing</a></li>
                </ul>
            </div>
            <!-- end footer column -->
            <!-- start footer column -->
            ...
            <div class="col-xl-3 col-lg-3 col-sm-6 md-mb-50px sm-mb-30px xs-mb-0 order-sm-2 order-lg-5">
                ...
                <div class="d-inline-block w-100 newsletter-style-02 position-relative">
                    <form action="email-templates/subscribe-newsletter.php" method="post" class="position-relative">
                        ...
                        <div
                            class="form-results border-radius-4px pt-5px pb-5px ps-15px pe-15px fs-14 lh-22 mt-10px w-100 text-center position-absolute d-none"></div>
                    </form>
                </div>
            </div>
            <!-- end footer column -->
        ...
        <div class="row justify-content-center align-items-center pt-2">
            ...
            <div
                ...
                <p>&copy; Powered by <a href="https://www.cybersparkglobal.com/" target="_blank"
                                        class="text-dark-gray fw-600 text-decoration-line-bottom">CyberSparkGlobal
                        </a>2025</p></div>
            <!-- end copyright -->
            <!-- start footer menu -->
