                    ...
                    <div class="card border-left-info shadow">
                        <div class="stat-widget-two card-body">
                            <div class="stat-content">
                                <div class="stat-text text-info">Today Expenses </div>
...
{{--                </div>--}}
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card border-left-success shadow">
                        <div class="stat-widget-two card-body">
                            <div class="stat-content">
                                <div class="stat-text text-success">Income Detail</div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card border-left-primary">
                        <div class="stat-widget-two card-body">
                            <div class="stat-content">
                                <div class="stat-text text-primary">Task Completed</div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card  border-left-warning">
                        <div class="stat-widget-two card-body">
                            <div class="stat-content">
                                <div class="stat-text text-warning">Task Completed</div>
