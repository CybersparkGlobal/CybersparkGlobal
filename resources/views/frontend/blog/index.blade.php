...
@section('content')
    ...
    <section class="top-space-margin page-title-big-typography border-radius-6px lg-border-radius-0px p-0" data-parallax-background-ratio="0.5" style="background-image: url({{ asset('http://cybersparkglobal.test/images/slider/blog%20page%20banner.jpg') }})">
