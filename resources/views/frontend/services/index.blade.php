                ...
                <div class="col-lg-4 pe-5 order-2 order-lg-1 lg-pe-3 md-pe-15px" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    <div class="bg-solitude-blue border-radius-6px p-45px lg-p-30px mb-25px">
                        ...
                        <ul class="p-0 m-0 list-style-02 fw-500">
                            ...
                            <li class="pb-10px mb-10px border-bottom border-color-transparent-dark"><a href="https://cybersparkglobal.com/contact_us">SEO and Marketing</a><i class="feather icon-feather-arrow-right ms-auto"></i></li>
                            <li class="pb-10px mb-10px border-bottom border-color-transparent-dark"><a href="https://cybersparkglobal.com/contact_us">Researching and Writing</a><i class="feather icon-feather-arrow-right ms-auto"></i></li>
